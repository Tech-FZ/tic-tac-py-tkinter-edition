...
def playerVsComputer(ticTacPyApp):
    ...
    def fieldZeroPlayer():
        if gamemodes.assets.cells.cell0 == " ":
            ...
            computerTurn()
            ticTacPyApp.gridCopy = [gamemodes.assets.cells.cell0, gamemodes.assets.cells.cell1, gamemodes.assets.cells.cell2, gamemodes.assets.cells.cell3, gamemodes.assets.cells.cell4, gamemodes.assets.cells.cell5, gamemodes.assets.cells.cell6, gamemodes.assets.cells.cell7, gamemodes.assets.cells.cell8]
    ...
    def computerTurn():
        ...
        if gamemodes.assets.turnCounter.playerOne != 0 and gamemodes.assets.turnCounter.playerOne > gamemodes.assets.turnCounter.playerTwo:
            #gridCopy = [gamemodes.assets.cells.cell0, gamemodes.assets.cells.cell1, gamemodes.assets.cells.cell2, gamemodes.assets.cells.cell3, gamemodes.assets.cells.cell4, gamemodes.assets.cells.cell5, gamemodes.assets.cells.cell6, gamemodes.assets.cells.cell7, gamemodes.assets.cells.cell8]
